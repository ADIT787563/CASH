  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error?.code) {
        ...
        // Use the mapped message, or the message from the server, or a generic fallback
        const message = errorMessages[error.code] || error.message || "Registration failed. Please try again.";
        toast.error(message);
        setIsLoading(false);
        return;
      }
      ...
      toast.success("Account created successfully! Welcome to WaveGroww!");
      router.push("/setup-profile");
    } catch (error) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Start your 3-day limited-feature trial — no card required</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8 shadow-lg">
          <button
            ...
            className="w-full bg-white text-black border border-gray-200 hover:bg-gray-50 font-medium py-3 rounded-lg transition-all flex items-center justify-center gap-2 mb-6"
          >
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            >
              ...
              {isLoading ? "Creating account..." : "Start 3-Day Trial"}
            </button>
          </form>
        </div>
